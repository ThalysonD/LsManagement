...
public class Usuario implements Serializable {
	...
	public Map<String, Object> getFormattedFuncionarios() {
		Map<String, Object> formattedFuncionarios = new HashMap<>();
		formattedFuncionarios.put("id", this.getId());
		formattedFuncionarios.put("telefone", this.getTelefone());
		formattedFuncionarios.put("senha", this.getSenha());
		...
		formattedFuncionarios.put("funcionarios", funcionariosList);

		return formattedFuncionarios;
	}
